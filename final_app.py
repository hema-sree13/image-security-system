...
st.set_page_config(page_title="Image Security System", page_icon="🛡️", layout="centered")
...
def detect_manipulation(image):
    ...
    if final_score < 15:
        ...
        results['color'] = 'real'
        results['emoji'] = '✅'
    elif final_score >= 15 and final_score < 100:
        results['verdict'] = 'MANIPULATED'
        results['confidence'] = round(final_score + 20, 1)
        results['color'] = 'fake'
        results['emoji'] = '🚨'
    else:
...
tab1, tab2, tab3, tab4 = st.tabs(["🔍 Detect Fake","🔒 Protect Image","✅ Verify Image","📋 Report Log"])
